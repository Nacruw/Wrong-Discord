import { Bell, Boost, FaceSmile, FolderPlus, Gear, LeaveServer, Pen, PersonAdd, PlusCircle, Shield, SpeakerMuted } from "@/components/Icons";
...
export const menuItems: ListRowElement[] = [
    ...
    {name: 'Invite People', icon: <PersonAdd/>, bottomBorder: false, purple: true},
    ...
    {name: 'Leave Server', icon: <LeaveServer/>, bottomBorder: false, red: true,},
];