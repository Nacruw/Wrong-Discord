...
export default function CreateChannelForm(): JSX.Element {
    ...
    // If you need videoClient, access it from another source or add it to DiscordContext
...
<dialog className='absolute top-2/5 left-2/5 z-10 space-y-2 rounded-xl' ref={dialogRef}>
            ...
            <form method="dialog" className="flex flex-col space-y-4 px-6">
                ...
                <label className="labelTitle flex items-center justify-between" htmlFor="category">
                    Category
                </label>
                <div className="flex items-center bg-gray-100 rounded">
                    <span className="text-2xl p-2 text-gray-500">#</span>
